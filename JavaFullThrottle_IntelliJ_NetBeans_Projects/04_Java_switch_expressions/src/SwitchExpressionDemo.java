...
public class SwitchExpressionDemo {
   public static void main(String[] args) {
      ...
      /*
         ...
         5. Cases may contain a block of code, but must use yield
            to specify case's value.
         6. Cases support individual values or comma-separated lists 
            of integers, enums or Strings.
         7. https://openjdk.org/jeps/427
         8. More future language enhancements: 
   ...
   static double getPerimeter(Object shape) throws IllegalArgumentException {
   ...
   static double getPerimeterSwitch(Object shape) throws IllegalArgumentException {
      return switch (shape) {
